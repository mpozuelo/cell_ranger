...
def add_bed_file(FileIn,FileOut):
    ...
    cov['fastq1'] = "/datos/ngs/dato-activo/data/04_pfastq/" + cov['platform'] + '/' + cov['run'] + '/demux_fastq/' + cov['sampleID'] + '_' + cov['run'] + '_' + cov['lane'] + '_R1.fq.gz'
    cov['fastq2'] = "/datos/ngs/dato-activo/data/04_pfastq/" + cov['platform'] + '/' + cov['run'] + '/demux_fastq/' + cov['sampleID'] + '_' + cov['run'] + '_' + cov['lane'] + '_R2.fq.gz'
